...
<html>
   <head>
      ...
      <title><?php echo "KFUEIT ACCESS SYSTEM"; ?> Download</title>
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
         <div class="container">
            <div class="navbar-header">
               <a class="navbar-brand" href="<?php echo ROOT_PHP; ?>"><span class="glyphicon glyphicon-chevron-left"></span>Back - <?php echo "KFUEIT ACCESS SYSTEM"; ?></a>


               <button onclick="openFullscreen();"><i class="fa fa-search-plus"></i></button>
<button onclick="closeFullscreen();"><i class="fa fa-search-minus"></i></button>
            </div>
         </div>
      </div>
